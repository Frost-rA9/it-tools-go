...
<template>
      <n-card title="XML 转 JSON — 输入" class="tool-card">
      <ToolTextarea v-model:value="inputText" label="输入 XML" :rows="20" placeholder="在此粘贴 XML…" />
    ...
    <n-card title="XML 转 JSON — 输出" class="tool-card">
