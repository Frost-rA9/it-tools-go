...
async function run() {
  try {
    const output = await RunTool('json-to-yaml', JSON.stringify({ text: inputText.value }))
...
<template>
  <n-card title="JSON 转 YAML — 输入" class="tool-card">
  ...
  <n-card title="JSON 转 YAML — 输出" class="tool-card">
